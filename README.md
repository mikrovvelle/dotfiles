...
This is just a personal fork of [Matthias' dotfiles](https://github.com/mathiasbynens/dotfiles/). It's more Apple-default-oriented in its treatment of the `.osx` config.
